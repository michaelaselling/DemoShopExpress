...
import static com.example.micka.coopshopexpress.Varukorg.setAllItemsToNotScanned;

public class Kvitto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kvitto);
    ...
    public void onSkannaClick (View view) {
        ...
        if (view.getId() == R.id.skannaButton) {
            ...
            Intent i = new Intent(Kvitto.this, End.class);
            startActivity(i);
