...
public class Popup12 extends AppCompatActivity {

    private static final String LOG_TAG = Popup12.class.getName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.d(LOG_TAG, "Setting warningmessage for share");
        setContentView(R.layout.popup12);
    ...
    public void onOkClick(View view) {
        ...
        if (view.getId() == R.id.okButton) {
            ...
            Intent i = new Intent(Popup12.this, Shoppinglistor.class);
            startActivity(i);
